...
.. code-block:: python
   ...
   Z = np.array([6, 13, 23]) # Nuclear charge of C, Al, and V
...
.. code-block:: python
   ...
   Am = 1.9944235e-23 # Atomic mass [g]
   rho_i = np.array([1, 10, 100]) # Mass densities [g/cc]
   T = np.logspace(-2, 5, 100) # Temperature range [eV]
   Z = 6 # Nuclear charge for carbon
...
.. code-block:: python
   ...
   T = np.logspace(-2, 5, 100) # Temperature range [eV]
   Z = np.array([1, 6, 26]) # Nuclear charge for each element
